...
async function checkDeduplication(title: string, deadline: Date, userId: string) {
...
async function upsertExtractedTask(sourceId: string, userId: string, extractedTask: ExtractedTask) {
...
async function saveExtraction(
    sourceInfo: { type: string; name?: string | undefined; rawContent: string; userId: string },
